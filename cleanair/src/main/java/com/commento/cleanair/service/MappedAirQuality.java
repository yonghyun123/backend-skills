...
@Builder
@ToString
public class MappedAirQuality {
    private String sido;
    private String sidoPm10Avg;
    private String sidoPm10AvgGrade;
    private List<MappedAirQuality.GuAirQuality> guList;

    public MappedAirQuality getAirQuality(String gu){
        MappedAirQuality.GuAirQuality guAirQuality = searchByGu(gu);
        guList = Collections.singletonList(guAirQuality);
        return this;
    }

    public MappedAirQuality.GuAirQuality searchByGu(String gu){
