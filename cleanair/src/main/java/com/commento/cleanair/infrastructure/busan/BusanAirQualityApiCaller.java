...
//    }
//
//    public AirQuality convert(BusanAirQualityApiDto response) {
...
//        List<GuAirQuality> guList = convert(response.getResult().getItems());
//
...
//    }
//
//    public List<GuAirQuality> convert(List<BusanAirQualityApiDto.Item> response){
//        return response
//                .stream()
//                .map(responseAir -> GuAirQuality
//                        .builder()
